...
export const COMMON_ITEMS_IDS: Record<string, Array<keyof typeof en.ingredients>> = {
  'Produce': ['onion', 'garlic', 'potato', 'carrot', 'tomato', 'lemon', 'lime', 'banana', 'spinach', 'pepper', 'cucumber', 'zucchini', 'lettuce', 'apple', 'orange', 'berry', 'blueberry', 'avocado', 'mushroom', 'ginger', 'chili', 'broccoli', 'cauliflower', 'sweet_potato', 'herbs'],
  ...
  'Pantry': ['rice', 'pasta', 'flour', 'sugar', 'olive_oil', 'veg_oil', 'canned_tomato', 'bean', 'lentil', 'quinoa', 'couscous', 'oat', 'cereal', 'chicken_broth', 'beef_broth', 'tomato_paste', 'honey', 'maple_syrup', 'peanut_butter', 'jam', 'baking_powder', 'yeast', 'vanilla_extract', 'baking_soda', 'cocoa_powder', 'chocolate_chips', 'vanilla_sugar', 'powdered_sugar', 'apple_sauce'],
