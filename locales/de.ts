...
export const de = {
  ...
  checkout_button: "Erledigt",
  add_item_placeholder: "Artikel hinzufügen...",
  empty_shopping_msg: "Deine Einkaufsliste ist leer.",

  // Swipe Deck
  pantry_empty_title: "Vorrat ist leer",
  pantry_empty_desc: "Füge Zutaten hinzu, um Rezepte zu entdecken!",
  loading_chef: "Frage die Chefs...",
  load_more: "Mehr Rezepte laden",
  like: "LECKER",
  nope: "NEE",
  ...
  expiry_alerts: "Ablauf-Warnung",
  expiry_desc: "Benachrichtigung bevor Essen verdirbt",
  danger_zone: "Gefahrenzone",
  clear_data: "Alle Daten löschen",
  are_you_sure: "Bist du sicher?",
  delete_warning: "Dies löscht deinen Vorrat, Einkaufsliste und Favoriten. Unwiderruflich.",
  cancel: "Abbrechen",
  ...
  ingredients: {
    // Produce
    onion: "Zwiebel", garlic: "Knoblauch", potato: "Kartoffel", carrot: "Karotte", tomato: "Tomate",
    lemon: "Zitrone", lime: "Limette", banana: "Banane", spinach: "Spinat", pepper: "Paprika",
    cucumber: "Gurke", zucchini: "Zucchini", lettuce: "Salat", apple: "Apfel",
    ...
    veg_oil: "Pflanzenöl", canned_tomato: "Dosentomaten", bean: "Bohnen",
    ...
    oregano: "Oregano", basil: "Basilikum", soy_sauce: "Sojasauce", vinegar: "Essig",
    garlic_powder: "Knoblauchpulver", onion_powder: "Zwiebelpulver", chili_flakes: "Chiliflocken",
    cinnamon: "Zimt", turmeric: "Kurkuma", curry_powder: "Currypulver",
    thyme: "Thymian", rosemary: "Rosmarin", mustard: "Senf", mayo: "Mayo",
    ketchup: "Ketchup", hot_sauce: "Scharfe Soße",

    // Frozen
    frozen_peas: "TK Erbsen", frozen_pizza: "TK Pizza", ice_cream: "Eiscreme",
    frozen_berries: "TK Beeren", fries: "Pommes", frozen_spinach: "TK Spinat",
    fish_sticks: "Fischstäbchen", frozen_corn: "TK Mais",

    // Snacks
    chips: "Chips", nuts: "Nüsse", chocolate: "Schokolade", cracker: "Cracker",
    popcorn: "Popcorn", cookie: "Kekse", granola_bar: "Müsliriegel", dried_fruit: "Trockenobst",

    // Beverages
    coffee: "Kaffee", tea: "Tee", water: "Wasser", juice: "Saft", soda: "Limo",
    beer: "Bier", wine: "Wein", sparkling_water: "Sprudelwasser",
  ...
  recipes: {
    pancakes: { title: "Klassische Pancakes", description: "Fluffige Pfannkuchen zum Frühstück.", steps: [
    ...
    spaghetti_aglio: { title: "Spaghetti Aglio e Olio", description: "Einfache Pasta mit Knoblauch und Öl.", steps: [
    ...
    scrambled_eggs: { title: "Cremiges Rührei", description: "Perfektes weiches Rührei.", steps: [
    ...
    grilled_cheese: { title: "Grilled Cheese Sandwich", description: "Knuspriges Käsesandwich.", steps: [
    ...
    carbonara: { title: "Spaghetti Carbonara", description: "Römischer Klassiker mit Ei und Speck.", steps: [
    ...
    chili_con_carne: { title: "Chili con Carne", description: "Würziger Eintopf mit Hackfleisch.", steps: [
    ...
    french_toast: { title: "Armer Ritter (French Toast)", description: "Süßes gebratenes Brot.", steps: [
    ...
    oatmeal: { title: "Haferbrei (Porridge)", description: "Gesundes warmes Frühstück.", steps: [
    ...
    potato_soup: { title: "Kartoffelsuppe", description: "Wärmende Suppe.", steps: [
    ...
    caprese: { title: "Caprese Salat", description: "Tomate-Mozzarella Salat.", steps: [
    ...
    chicken_curry: { title: "Hähnchen Curry", description: "Mildes Sahne-Curry.", steps: [
    ...
    // New Additions
    schnitzel: { title: "Wiener Schnitzel", description: "Knusprig paniertes Schnitzel.", steps: [
    ...
    bratkartoffeln: { title: "Bratkartoffeln", description: "Deftige krosse Kartoffeln.", steps: [
    ...
    currywurst: { title: "Currywurst", description: "Wurst mit Currysauce.", steps: [
    ...
    kaesespaetzle: { title: "Käsespätzle", description: "Der schwäbische Klassiker.", steps: [
    ...
    risotto_mushroom: { title: "Pilz Risotto", description: "Cremiger italienischer Reis.", steps: [
    ...
    lasagne: { title: "Klassische Lasagne", description: "Geschichteter Auflauf.", steps: [
    ...
    bruschetta: { title: "Tomaten Bruschetta", description: "Geröstetes Brot mit Tomaten.", steps: [
    ...
    tiramisu: { title: "Tiramisu", description: "Dessert mit Kaffee.", steps: [
    ...
    fried_rice: { title: "Gebratener Reis", description: "Schnelles asiatisches Gericht.", steps: [
    ...
    beef_broccoli: { title: "Rindfleisch mit Brokkoli", description: "Wok Klassiker.", steps: [
    ...
    teriyaki_chicken: { title: "Teriyaki Hähnchen", description: "Süß glasiertes Hähnchen.", steps: [
    ...
    summer_rolls: { title: "Sommerrollen", description: "Frische Reispapier-Rollen.", steps: [
    ...
    pad_thai: { title: "Pad Thai", description: "Gebratene Nudeln.", steps: [
      "Nudeln einweichen: 200g Reisnudeln in eine große Schüssel geben. Mit heißem (nicht kochendem) Wasser bedecken und 20-30 Minuten einweichen lassen, bis sie weich, aber noch leicht fest sind. Sie sollten biegsam, aber nicht matschig sein. Vor dem Kochen gut abgießen.",
      "Zutaten vorbereiten: 200g Tofu (oder Hähnchen) in kleine Würfel schneiden. 2 Eier verquirlen. 2 EL Sojasauce, 1 EL Fischsauce (optional), 1 Limette und 2 EL gehackte Erdnüsse bereithalten. 1 Limette in Spalten schneiden.",
      "Sauce herstellen: In einer kleinen Schüssel 2 EL Sojasauce, 1 EL Fischsauce (oder mehr Sojasauce), 1 EL Zucker, 1 EL Limettensaft und 1 TL Chiliflocken mischen. Umrühren, bis der Zucker sich auflöst.",
      "Protein anbraten: 2 EL Öl in einem Wok oder einer großen Pfanne bei hoher Hitze erhitzen. Tofu (oder Hähnchen) hinzufügen und 3-4 Minuten braten, bis goldbraun. Zur Seite schieben. Verquirlte Eier hinzufügen und schnell rühren. Mit Tofu mischen.",
      "Nudeln hinzufügen: Abgetropfte Nudeln zur Pfanne geben. Sauce hineingießen. Bei hoher Hitze 3-4 Minuten anbraten, ständig schwenken, bis die Nudeln durchgewärmt und gut mit Sauce bedeckt sind.",
      "Fertigstellen: 2 EL gehackte Erdnüsse hinzufügen und schwenken. Die Nudeln sollten leicht zäh, gut gewürzt und nicht matschig sein. Wenn sie zu trocken sind, einen Schuss Wasser hinzufügen.",
      "Servieren: Auf Teller übertragen und mit zusätzlichen Erdnüssen, Limettenspalten und frischem Koriander nach Wunsch garnieren. Sofort servieren, solange heiß. Limette darüber auspressen vor dem Essen."
    ] },
    tacos: { title: "Rinder Tacos", description: "Gefüllte Maisschalen.", steps: [
    ...
    quesadillas: { title: "Käse Quesadillas", description: "Gegrillte Tortillas.", steps: [
    ...
    guacamole: { title: "Frische Guacamole", description: "Avocado Dip.", steps: [
    ...
    burger: { title: "Klassischer Burger", description: "Saftiger Rindfleisch-Burger.", steps: [
    ...
    greek_salad: { title: "Griechischer Salat", description: "Frischer Salat mit Feta.", steps: [
    ...
    shakshuka: { title: "Shakshuka", description: "Eier in Tomatensauce.", steps: [
    ...
    caesar_salad: { title: "Caesar Salad", description: "Salat mit cremigem Dressing.", steps: [
    ...
    banana_bread: { title: "Bananenbrot", description: "Saftiger Kuchen.", steps: [
    ...
    smoothie_bowl: { title: "Beeren Smoothie Bowl", description: "Dicker Smoothie zum Löffeln.", steps: [
    ...
    // Erweiterungen
    frozen_pizza_upgrade: { title: "Tiefkühlpizza Deluxe", description: "Fertige Pizza aufpeppen.", steps: [
    ...
    doner_plate: { title: "Döner-Teller", description: "Schnelles Imbiss-Gericht.", steps: [
    ...
    roasted_veg_feta: { title: "Ofengemüse mit Feta", description: "Blechgericht ohne Aufwand.", steps: [
      "Ofen vorheizen: Ofen auf 200°C vorheizen. Ein großes Backblech mit Backpapier oder Folie auslegen für einfache Reinigung.",
      "Gemüse vorbereiten: 600g Kartoffeln, 2 Karotten und 1 Zucchini waschen und in 2-3cm große Würfel schneiden. Versuchen Sie, sie ähnlich groß zu machen für gleichmäßiges Garen. Alles Gemüse in eine große Schüssel geben.",
      "Gemüse würzen: 3 EL Olivenöl über das Gemüse träufeln. 1 TL Salz, 1/2 TL schwarzen Pfeffer und 1 TL getrocknete Kräuter (Oregano, Thymian oder italienische Gewürzmischung) hinzufügen. Schwenken, bis alles gleichmäßig bedeckt ist.",
      "Rösten: Gemüse in einer einzigen Schicht auf dem vorbereiteten Backblech verteilen. Nicht überfüllen - bei Bedarf zwei Bleche verwenden. 25-30 Minuten rösten, bis das Gemüse zart ist und zu bräunen beginnt, nach der Hälfte der Zeit umrühren.",
      "Feta hinzufügen: Nach 25-30 Minuten 150g Feta-Käse über das Gemüse zerbröseln. Zurück in den Ofen geben und weitere 5-7 Minuten backen, bis der Feta leicht geschmolzen ist und das Gemüse vollständig zart ist.",
      "Garheit prüfen: Das Gemüse sollte weich sein, wenn es mit einer Gabel durchstochen wird, mit einigen knusprigen Kanten. Der Feta sollte warm und leicht geschmolzen, aber nicht vollständig flüssig sein.",
      "Servieren: Aus dem Ofen nehmen und 2 Minuten abkühlen lassen. Heiß direkt vom Blech servieren oder auf eine Servierschüssel übertragen. Das Gemüse sollte zart sein, der Feta sollte cremig sein, und alles sollte gut gewürzt sein."
    ] },
    ramen_weeknight: { title: "Schnelle Ramen", description: "Nudel-Suppe mit Ei.", steps: [
    ...
    sauerbraten: { title: "Sauerbraten", description: "Sonntagsbraten mit Sauce.", steps: [
    ...
    paella: { title: "Einfache Paella", description: "Reispfanne mit Huhn und Meeresfrüchten.", steps: [
    ...
    lentil_stew: { title: "Linseneintopf", description: "Deftiger Klassiker.", steps: [
    ...
    gnocchi_sage: { title: "Gnocchi in Salbeibutter", description: "Schnelle Pfannenpasta.", steps: [
      "Gnocchi kochen: Einen großen Topf mit gut gesalzenem Wasser zum kräftigen Kochen bringen. 500g Gnocchi (frisch oder verpackt) hinzufügen und nach Packungsanleitung kochen. Frische Gnocchi sind fertig, wenn sie an die Oberfläche steigen (meist 2-3 Minuten).",
      "Salbei vorbereiten: Während die Gnocchi kochen, 1 Handvoll frischer Salbeiblätter pflücken. Waschen und vollständig trocken tupfen - jedes Wasser lässt die Butter spritzen. 80g Butter bereithalten.",
      "Butter schmelzen: 80g Butter in einer großen Pfanne bei mittlerer Hitze erhitzen. Sobald die Butter geschmolzen ist und zu schäumen beginnt, Salbeiblätter hinzufügen. 2-3 Minuten kochen, bis die Butter goldbraun ist und der Salbei knusprig ist. Die Butter sollte nussig riechen - das ist braune Butter (beurre noisette).",
      "Gnocchi abgießen: Sobald die Gnocchi an die Oberfläche steigen, gut abtropfen lassen. Nicht abspülen - die Stärke hilft der Sauce zu haften. Abgetropfte Gnocchi direkt in die Pfanne mit Butter geben.",
      "Schwenken: Gnocchi in der braunen Butter und dem Salbei 1-2 Minuten bei mittlerer Hitze schwenken, bis sie gut bedeckt und außen leicht knusprig sind. Die Gnocchi sollten goldbraun sein und der Salbei sollte knusprig sein.",
      "Fertigstellen: Vom Herd nehmen. 50g geriebenen Parmesan und eine großzügige Menge frisch gemahlenen schwarzen Pfeffer hinzufügen. Einmal mehr schwenken, bis der Käse geschmolzen ist.",
      "Servieren: Sofort in warmen Schalen servieren. Die Gnocchi sollten innen zart, außen leicht knusprig sein und mit nussiger brauner Butter bedeckt sein. Der knusprige Salbei fügt Textur und Geschmack hinzu. Am besten sofort essen."
    ] },
    fishsticks_mash: { title: "Fischstäbchen & Kartoffelpüree", description: "Kinderfreundlich und schnell.", steps: [
    ...
    quiche_lorraine: { title: "Quiche Lorraine", description: "Herzhafter Kuchen.", steps: [
      "Teig herstellen: In einer Küchenmaschine oder Schüssel 250g Mehl, 125g kalte Butter (gewürfelt) und 1 Ei kombinieren. Pulsieren oder mischen, bis es einen Teig bildet. Alternativ Butter mit den Fingern ins Mehl einarbeiten, dann Ei hinzufügen. Zu einer Kugel formen, in Folie wickeln und 30 Minuten im Kühlschrank kühlen.",
      "Füllung kochen: Während der Teig kühlt, 150g Speck und 1 Zwiebel würfeln. Speck in einer Pfanne bei mittlerer Hitze 5-6 Minuten braten, bis knusprig. Speck entfernen, Zwiebel in dieselbe Pfanne geben und 4-5 Minuten kochen, bis weich. Beiseite stellen.",
      "Guss herstellen: In einer Schüssel 4 Eier, 200ml Sahne, 1/2 TL Salz, 1/4 TL schwarzen Pfeffer und eine Prise Muskat verquirlen, bis glatt und gut vermischt. Die Mischung sollte gleichmäßig sein.",
      "Teig ausrollen: Ofen auf 180°C vorheizen. Gekühlten Teig auf einer bemehlten Fläche ausrollen, um eine 23cm Tarteform zu passen. Vorsichtig die Form auslegen, in die Ecken drücken. Überschuss abschneiden. Den Boden mit einer Gabel einstechen.",
      "Blind backen: Teig mit Backpapier auslegen und mit Backbohnen oder Reis füllen. 15 Minuten backen. Papier und Bohnen entfernen, weitere 5 Minuten backen, bis leicht goldbraun. Aus dem Ofen nehmen.",
      "Zusammenbauen: Speck- und Zwiebelmischung über den Teigboden verteilen. Mit 100g geriebenem Käse bestreuen. Gussmischung darüber gießen, bis knapp unter den Rand füllen.",
      "Backen: 35-40 Minuten backen, bis der Guss fest ist (er sollte in der Mitte leicht wackeln, aber an den Rändern fest sein) und die Oberseite goldbraun ist. 10 Minuten abkühlen lassen, bevor Sie schneiden. Warm oder bei Raumtemperatur servieren."
    ] },
    stuffed_peppers: { title: "Gefüllte Paprika", description: "Aus dem Ofen mit Reisfüllung.", steps: [
    ...
    ratatouille: { title: "Schnelles Ratatouille", description: "Gemüse-Eintopf.", steps: [
    ...
    sheetpan_salmon: { title: "Ofenlachs & Gemüse", description: "Alles auf einem Blech.", steps: [
      "Ofen vorheizen: Ofen auf 200°C vorheizen. Ein großes Backblech mit Backpapier oder Folie auslegen für einfache Reinigung.",
      "Gemüse vorbereiten: 600g Kartoffeln in 2cm große Stücke schneiden. 300g Brokkoli in Röschen schneiden. Beides mit 3 EL Olivenöl, 1 TL Salz und 1/2 TL schwarzem Pfeffer mischen, bis gleichmäßig bedeckt.",
      "Gemüse rösten: Gemüse in einer einzigen Schicht auf dem vorbereiteten Backblech verteilen. 15 Minuten rösten, bis die Kartoffeln zu weichen beginnen und der Brokkoli hellgrün ist. Nach der Hälfte der Zeit umrühren.",
      "Lachs vorbereiten: Während das Gemüse röstet, 4 Lachsfilets mit Küchenpapier trocken tupfen. Mit 1 EL Zitronensaft, 1/2 TL Salz und 1/4 TL schwarzem Pfeffer einreiben. 1 Zitrone in dünne Scheiben schneiden.",
      "Lachs hinzufügen: Nach 15 Minuten Gemüse zur Seite schieben, um Platz zu machen. Lachsfilets auf das Backblech legen, Hautseite nach unten, falls sie Haut haben. Zitronenscheiben auf den Lachs legen.",
      "Fertig backen: Zurück in den Ofen geben und weitere 12-15 Minuten backen, bis der Lachs gerade durchgegart ist (er sollte sich leicht mit einer Gabel zerteilen lassen) und das Gemüse zart ist. Der Lachs sollte undurchsichtig, aber noch feucht sein.",
      "Servieren: Aus dem Ofen nehmen. Der Lachs sollte perfekt gegart sein, das Gemüse sollte zart sein, und alles sollte gut gewürzt sein. Sofort auf dem Backblech servieren oder auf Teller übertragen. Vor dem Servieren frische Zitrone darüber pressen."
    ] },
    tofu_stirfry: { title: "Tofu Gemüse Wok", description: "Leichtes Asia-Gericht.", steps: [
    ...
    poke_bowl: { title: "Schnelle Poke Bowl", description: "Kaltes Schüsselgericht.", steps: [
    ...
    taco_salad: { title: "Taco-Salat", description: "Ohne Taco-Hüllen.", steps: [
    ...
    kaiserschmarrn: { title: "Kaiserschmarrn", description: "Süße Pfannenschmarrn.", steps: [
      "Eier trennen: 4 Eier vorsichtig trennen, Eiweiß in eine große saubere Schüssel geben und Eigelb in eine mittlere Schüssel. Sicherstellen, dass kein Eigelb ins Eiweiß gelangt, sonst schlagen sie nicht richtig.",
      "Eiweiß schlagen: Mit einem elektrischen Mixer oder Schneebesen Eiweiß bei hoher Geschwindigkeit schlagen, bis sie steife Spitzen bilden (ca. 3-5 Minuten). Das Eiweiß sollte seine Form halten, wenn Sie den Schneebesen anheben. Beiseite stellen.",
      "Eigelb mischen: Zu den Eigelben 200g Mehl, 250ml Milch und 60g Zucker hinzufügen. Verquirlen, bis glatt und gut vermischt. Die Mischung sollte dick, aber gießbar sein.",
      "Eiweiß unterheben: Geschlagenes Eiweiß sanft in die Eigelbmischung unterheben, einen Spatel verwenden. Eine Schneid- und Faltbewegung verwenden - nicht rühren, sonst fällt das Eiweiß zusammen. Mischen, bis gerade vermischt, mit einigen weißen Streifen verbleibend.",
      "Pfannkuchen kochen: 50g Butter in einer großen beschichteten Pfanne (mindestens 28cm) bei mittlerer Hitze erhitzen. Den gesamten Teig hineingießen. 4-5 Minuten kochen, bis die Unterseite goldbraun ist und die Oberseite zu setzen beginnt.",
      "Zerreißen und wenden: Mit zwei Spateln den Pfannkuchen in große Stücke zerreißen und umdrehen. Keine Sorge um perfekte Stücke - der zerrissene Look ist traditionell. Weitere 3-4 Minuten kochen, bis beide Seiten goldbraun sind.",
      "Karamellisieren und servieren: 1 weiteren EL Butter und 1 EL Zucker hinzufügen. Die Stücke sanft schwenken, um leicht zu karamellisieren. Der Pfannkuchen sollte fluffig, goldbraun und leicht süß sein. Sofort servieren, mit Puderzucker bestäubt. Am besten heiß essen!"
    ] },
    roast_chicken_tray: { title: "Blechhähnchen", description: "Abendessen aus einem Blech.", steps: [
      "Ofen vorheizen: Ofen auf 200°C vorheizen. Ein großes Backblech mit Backpapier oder Folie auslegen für einfache Reinigung.",
    ...
    overnight_oats: { title: "Overnight Oats", description: "Frühstück über Nacht.", steps: [
    ...
    nachos_supreme: { title: "Blech-Nachos", description: "Party-Snack.", steps: [
      "Ofen vorheizen: Ofen auf 180°C vorheizen. Ein großes Backblech mit Backpapier oder Folie auslegen für einfache Reinigung.",
      "Fleisch braten: 2 EL Öl in einer Pfanne bei mittlerer bis hoher Hitze erhitzen. 250g Hackfleisch hinzufügen und 5-6 Minuten braten, dabei zerkleinern, bis es gebräunt ist. 1 EL Chiliflocken und 1 EL Paprika hinzufügen. Umrühren und 1 weitere Minute kochen. Überschüssiges Fett abgießen und warm halten.",
      "Toppings vorbereiten: 1 Dose Bohnen abgießen. 1 Paprika und 2 Tomaten würfeln. 200g geriebenen Käse bereithalten. Alle anderen gewünschten Toppings vorbereiten (Jalapeños, Oliven, etc.).",
      "Nachos schichten: 1 große Tüte Tortilla-Chips in einer einzigen Schicht auf dem vorbereiteten Backblech verteilen. Gekochtes Fleisch und abgetropfte Bohnen gleichmäßig über die Chips streuen. Gewürfelte Paprika und Tomaten hinzufügen.",
      "Käse hinzufügen: Geriebenen Käse großzügig über alles streuen. Sicherstellen, dass die Chips gut bedeckt sind - der Käse hilft, alles zusammenzuhalten.",
      "Backen: In den vorgeheizten Ofen geben und 8-10 Minuten backen, bis der Käse geschmolzen und blubbernd ist. Vorsichtig beobachten - Chips können schnell verbrennen. Der Käse sollte vollständig geschmolzen und an einigen Stellen goldbraun sein.",
      "Servieren: Sofort aus dem Ofen nehmen. Heiß direkt vom Blech mit Salsa, Sauerrahm, Guacamole oder Joghurt servieren. Die Nachos sollten knusprig, käsig und mit Toppings beladen sein. Am besten sofort essen, solange der Käse noch klebrig ist!"
    ] }
  }
};
