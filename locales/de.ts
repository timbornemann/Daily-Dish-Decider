...
export const de = {
  ...
  recipes: {
    pancakes: {
      title: "Klassische Pancakes", description: "Fluffige Pfannkuchen zum Frühstück.", steps: [
    ...
    spaghetti_aglio: {
      title: "Spaghetti Aglio e Olio", description: "Einfache Pasta mit Knoblauch und Öl.", steps: [
    ...
    scrambled_eggs: {
      title: "Cremiges Rührei", description: "Perfektes weiches Rührei.", steps: [
    ...
    grilled_cheese: {
      title: "Grilled Cheese Sandwich", description: "Knuspriges Käsesandwich.", steps: [
    ...
    carbonara: {
      title: "Spaghetti Carbonara", description: "Römischer Klassiker mit Ei und Speck.", steps: [
    ...
    chili_con_carne: {
      title: "Chili con Carne", description: "Würziger Eintopf mit Hackfleisch.", steps: [
    ...
    french_toast: {
      title: "Armer Ritter (French Toast)", description: "Süßes gebratenes Brot.", steps: [
    ...
    oatmeal: {
      title: "Haferbrei (Porridge)", description: "Gesundes warmes Frühstück.", steps: [
    ...
    potato_soup: {
      title: "Kartoffelsuppe", description: "Wärmende Suppe.", steps: [
    ...
    caprese: {
      title: "Caprese Salat", description: "Tomate-Mozzarella Salat.", steps: [
    ...
    chicken_curry: {
      title: "Hähnchen Curry", description: "Mildes Sahne-Curry.", steps: [
    ...
    // New Additions
    schnitzel: {
      title: "Wiener Schnitzel", description: "Knusprig paniertes Schnitzel.", steps: [
    ...
    bratkartoffeln: {
      title: "Bratkartoffeln", description: "Deftige krosse Kartoffeln.", steps: [
    ...
    currywurst: {
      title: "Currywurst", description: "Wurst mit Currysauce.", steps: [
    ...
    kaesespaetzle: {
      title: "Käsespätzle", description: "Der schwäbische Klassiker.", steps: [
    ...
    risotto_mushroom: {
      title: "Pilz Risotto", description: "Cremiger italienischer Reis.", steps: [
    ...
    lasagne: {
      title: "Klassische Lasagne", description: "Geschichteter Auflauf.", steps: [
    ...
    bruschetta: {
      title: "Tomaten Bruschetta", description: "Geröstetes Brot mit Tomaten.", steps: [
    ...
    tiramisu: {
      title: "Tiramisu", description: "Dessert mit Kaffee.", steps: [
    ...
    fried_rice: {
      title: "Gebratener Reis", description: "Schnelles asiatisches Gericht.", steps: [
    ...
    beef_broccoli: {
      title: "Rindfleisch mit Brokkoli", description: "Wok Klassiker.", steps: [
    ...
    teriyaki_chicken: {
      title: "Teriyaki Hähnchen", description: "Süß glasiertes Hähnchen.", steps: [
    ...
    summer_rolls: {
      title: "Sommerrollen", description: "Frische Reispapier-Rollen.", steps: [
    ...
    pad_thai: {
      title: "Pad Thai", description: "Gebratene Nudeln.", steps: [
    ...
    tacos: {
      title: "Rinder Tacos", description: "Gefüllte Maisschalen.", steps: [
    ...
    quesadillas: {
      title: "Käse Quesadillas", description: "Gegrillte Tortillas.", steps: [
    ...
    guacamole: {
      title: "Frische Guacamole", description: "Avocado Dip.", steps: [
    ...
    burger: {
      title: "Klassischer Burger", description: "Saftiger Rindfleisch-Burger.", steps: [
    ...
    greek_salad: {
      title: "Griechischer Salat", description: "Frischer Salat mit Feta.", steps: [
    ...
    shakshuka: {
      title: "Shakshuka", description: "Eier in Tomatensauce.", steps: [
    ...
    caesar_salad: {
      title: "Caesar Salad", description: "Salat mit cremigem Dressing.", steps: [
    ...
    banana_bread: {
      title: "Bananenbrot", description: "Saftiger Kuchen.", steps: [
    ...
    smoothie_bowl: {
      title: "Beeren Smoothie Bowl", description: "Dicker Smoothie zum Löffeln.", steps: [
    ...
    // Erweiterungen
    frozen_pizza_upgrade: {
      title: "Tiefkühlpizza Deluxe", description: "Fertige Pizza aufpeppen.", steps: [
    ...
    doner_plate: {
      title: "Döner-Teller", description: "Schnelles Imbiss-Gericht.", steps: [
    ...
    roasted_veg_feta: {
      title: "Ofengemüse mit Feta", description: "Blechgericht ohne Aufwand.", steps: [
    ...
    ramen_weeknight: {
      title: "Schnelle Ramen", description: "Nudel-Suppe mit Ei.", steps: [
    ...
    sauerbraten: {
      title: "Sauerbraten", description: "Sonntagsbraten mit Sauce.", steps: [
    ...
    paella: {
      title: "Einfache Paella", description: "Reispfanne mit Huhn und Meeresfrüchten.", steps: [
    ...
    lentil_stew: {
      title: "Linseneintopf", description: "Deftiger Klassiker.", steps: [
    ...
    gnocchi_sage: {
      title: "Gnocchi in Salbeibutter", description: "Schnelle Pfannenpasta.", steps: [
    ...
    fishsticks_mash: {
      title: "Fischstäbchen & Kartoffelpüree", description: "Kinderfreundlich und schnell.", steps: [
    ...
    quiche_lorraine: {
      title: "Quiche Lorraine", description: "Herzhafter Kuchen.", steps: [
    ...
    stuffed_peppers: {
      title: "Gefüllte Paprika", description: "Aus dem Ofen mit Reisfüllung.", steps: [
    ...
    ratatouille: {
      title: "Schnelles Ratatouille", description: "Gemüse-Eintopf.", steps: [
    ...
    sheetpan_salmon: {
      title: "Ofenlachs & Gemüse", description: "Alles auf einem Blech.", steps: [
        "Ofen vorheizen: Ofen auf 200°C vorheizen. Ein großes Backblech mit Backpapier oder Folie auslegen für einfache Reinigung.",
    ...
    tofu_stirfry: {
      title: "Tofu Gemüse Wok", description: "Leichtes Asia-Gericht.", steps: [
    ...
    poke_bowl: {
      title: "Schnelle Poke Bowl", description: "Kaltes Schüsselgericht.", steps: [
    ...
    taco_salad: {
      title: "Taco-Salat", description: "Ohne Taco-Hüllen.", steps: [
    ...
    kaiserschmarrn: {
      title: "Kaiserschmarrn", description: "Süße Pfannenschmarrn.", steps: [
    ...
    roast_chicken_tray: {
      title: "Blechhähnchen", description: "Abendessen aus einem Blech.", steps: [
        "Ofen vorheizen: Ofen auf 200°C vorheizen. Ein großes Backblech mit Backpapier oder Folie auslegen für einfache Reinigung.",
    ...
    overnight_oats: {
      title: "Overnight Oats", description: "Frühstück über Nacht.", steps: [
    ...
    nachos_supreme: {
      title: "Blech-Nachos", description: "Party-Snack.", steps: [
    ...
    // --- NEU: Pasta Variationen ---
    nudeln_pesto: {
      title: "Nudeln mit Pesto", description: "Schnelle grüne Pasta.", steps: [
    ...
    nudeln_tomatensauce: {
      title: "Nudeln mit Tomatensauce", description: "Der Klassiker Napoli.", steps: [
    ...
    nudeln_kaesesauce: {
      title: "Nudeln in Käsesauce", description: "Cremig und deftig.", steps: [
    ...
    nudeln_auflauf: {
      title: "Nudelauflauf", description: "Überbackener Genuss.", steps: [
    ...
    nudeln_salat: {
      title: "Klassischer Nudelsalat", description: "Der Partyhit mit Mayo.", steps: [
