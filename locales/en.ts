...
export const en = {
  ...
  recipes: {
    pancakes: {
      title: "Classic Pancakes", description: "Fluffy breakfast pancakes.", steps: [
    ...
    spaghetti_aglio: {
      title: "Spaghetti Aglio e Olio", description: "Simple garlic and oil pasta.", steps: [
    ...
    scrambled_eggs: {
      title: "Creamy Scrambled Eggs", description: "Perfect soft scrambled eggs.", steps: [
    ...
    grilled_cheese: {
      title: "Grilled Cheese Sandwich", description: "Crispy, cheesy comfort food.", steps: [
    ...
    carbonara: {
      title: "Spaghetti Carbonara", description: "Roman classic with egg and bacon.", steps: [
    ...
    chili_con_carne: {
      title: "Chili con Carne", description: "Spicy beef and bean stew.", steps: [
    ...
    french_toast: {
      title: "French Toast", description: "Sweet fried bread.", steps: [
    ...
    oatmeal: {
      title: "Morning Oatmeal", description: "Healthy warm breakfast.", steps: [
    ...
    potato_soup: {
      title: "Creamy Potato Soup", description: "Warming winter soup.", steps: [
    ...
    caprese: {
      title: "Caprese Salad", description: "Fresh Italian salad.", steps: [
    ...
    chicken_curry: {
      title: "Easy Chicken Curry", description: "Mild creamy curry.", steps: [
    ...
    // New additions
    schnitzel: {
      title: "Wiener Schnitzel", description: "Crispy breaded cutlet.", steps: [
    ...
    bratkartoffeln: {
      title: "Fried Potatoes", description: "German style crispy potatoes.", steps: [
    ...
    currywurst: {
      title: "Currywurst", description: "Sausage with curry sauce.", steps: [
    ...
    kaesespaetzle: {
      title: "Cheese Spaetzle", description: "German mac and cheese.", steps: [
    ...
    risotto_mushroom: {
      title: "Mushroom Risotto", description: "Cremy Italian rice.", steps: [
    ...
    lasagne: {
      title: "Classic Lasagne", description: "Layered pasta bake.", steps: [
    ...
    bruschetta: {
      title: "Tomato Bruschetta", description: "Toasted bread with tomatoes.", steps: [
    ...
    tiramisu: {
      title: "Tiramisu", description: "Coffee flavored dessert.", steps: [
    ...
    fried_rice: {
      title: "Egg Fried Rice", description: "Quick Asian rice dish.", steps: [
    ...
    beef_broccoli: {
      title: "Beef and Broccoli", description: "Stir fry classic.", steps: [
    ...
    teriyaki_chicken: {
      title: "Teriyaki Chicken", description: "Sweet glazed chicken.", steps: [
    ...
    summer_rolls: {
      title: "Fresh Summer Rolls", description: "Rice paper rolls.", steps: [
    ...
    pad_thai: {
      title: "Pad Thai", description: "Fried noodles.", steps: [
    ...
    tacos: {
      title: "Beef Tacos", description: "Crunchy filled shells.", steps: [
    ...
    quesadillas: {
      title: "Cheese Quesadillas", description: "Grilled cheese tortillas.", steps: [
    ...
    guacamole: {
      title: "Fresh Guacamole", description: "Avocado dip.", steps: [
    ...
    burger: {
      title: "Classic Burger", description: "Juicy beef burger.", steps: [
    ...
    greek_salad: {
      title: "Greek Salad", description: "Fresh feta salad.", steps: [
    ...
    shakshuka: {
      title: "Shakshuka", description: "Eggs poached in tomato sauce.", steps: [
    ...
    caesar_salad: {
      title: "Caesar Salad", description: "Creamy lettuce salad.", steps: [
    ...
    banana_bread: {
      title: "Banana Bread", description: "Moist fruit cake.", steps: [
    ...
    smoothie_bowl: {
      title: "Berry Smoothie Bowl", description: "Thick smoothie.", steps: [
    ...
    frozen_pizza_upgrade: {
      title: "Frozen Pizza Glow-Up", description: "Upgrade a ready pizza.", steps: [
    ...
    doner_plate: {
      title: "Doner Plate", description: "Imbiss classic at home.", steps: [
    ...
    roasted_veg_feta: {
      title: "Roasted Veg & Feta", description: "Sheet-pan dinner.", steps: [
    ...
    ramen_weeknight: {
      title: "Weeknight Ramen", description: "Brothy noodles with egg.", steps: [
    ...
    sauerbraten: {
      title: "Sauerbraten", description: "Slow-braised roast.", steps: [
    ...
    paella: {
      title: "Easy Paella", description: "Rice pan with chicken and shrimp.", steps: [
    ...
    lentil_stew: {
      title: "Lentil Stew", description: "Hearty one-pot.", steps: [
    ...
    gnocchi_sage: {
      title: "Gnocchi Sage Butter", description: "Pan pasta in minutes.", steps: [
    ...
    fishsticks_mash: {
      title: "Fish Sticks & Mash", description: "Kid-friendly combo.", steps: [
    ...
    quiche_lorraine: {
      title: "Quiche Lorraine", description: "Savory tart.", steps: [
    ...
    stuffed_peppers: {
      title: "Stuffed Peppers", description: "Baked rice-beef filling.", steps: [
    ...
    ratatouille: {
      title: "Quick Ratatouille", description: "Vegetable stew.", steps: [
    ...
    sheetpan_salmon: {
      title: "Sheet-Pan Salmon", description: "One tray meal.", steps: [
        "Preheat oven: Preheat oven to 200°C/390°F. Line a large baking sheet with parchment paper or foil for easy cleanup.",
    ...
    tofu_stirfry: {
      title: "Tofu Veggie Stir-Fry", description: "Light Asian-style dish.", steps: [
    ...
    poke_bowl: {
      title: "Quick Poke Bowl", description: "No-cook assembly.", steps: [
    ...
    taco_salad: {
      title: "Taco Salad", description: "All the flavor, no shells.", steps: [
    ...
    kaiserschmarrn: {
      title: "Kaiserschmarrn", description: "Fluffy torn pancake.", steps: [
    ...
    roast_chicken_tray: {
      title: "Tray-Bake Chicken", description: "Sheet-pan dinner.", steps: [
        "Preheat oven: Preheat oven to 200°C/390°F. Line a large baking sheet with parchment paper or foil for easy cleanup.",
    ...
    overnight_oats: {
      title: "Overnight Oats", description: "Breakfast that waits.", steps: [
    ...
    nachos_supreme: {
      title: "Sheet-Pan Nachos", description: "Party snack.", steps: [
    ...
    nudeln_pesto: {
      title: "Pasta with Pesto", description: "Quick green pasta.", steps: [
    ...
    nudeln_tomatensauce: {
      title: "Pasta Tomato Sauce", description: "Classic Napoli style.", steps: [
    ...
    nudeln_kaesesauce: {
      title: "Pasta Cheese Sauce", description: "Creamy and cheesy.", steps: [
    ...
    nudeln_auflauf: {
      title: "Pasta Casserole", description: "Baked cheesy goodness.", steps: [
    ...
    nudeln_salat: {
      title: "Classic Pasta Salad", description: "Party hit with mayo.", steps: [
